...
#define ID_WINDOW1 1
#define ID_WINDOW1_TEXT 2
#define ID_WINDOW1_DUTY 3
#define ID_WINDOW1_SPEED1 4
#define ID_SW 5
#define ID_HW 6
#define ID_WINDOW1_NOMBRES 7
#define ID_WINDOW1_PORCENTAJE 8
#define ID_WINDOW1_SETPOINT 9
#define ID_WINDOW1_SPEED 10
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_CONTROL;
    GX_PROMPT window1_NOMBRE_PROYECTO;
    GX_PROMPT window1_CONTROL_2;
    GX_PROMPT window1_SPEED1;
    GX_PROMPT window1_SW;
    GX_PROMPT window1_HW;
    GX_PROMPT window1_NOMBRES;
    GX_PROMPT window1_PORCENTAJE;
    GX_PROMPT window1_PORCENTAJE_1;
    GX_PROMPT window1_SW_1;
    GX_PROMPT window1_HW_1;
    GX_PROMPT window1_NOMBRES_1;
    GX_PROMPT window1_NOMBRES_2;
    GX_PROMPT window1_SW_2;
    GX_PROMPT window1_PORCENTAJE_2;
    GX_PROMPT window1_SETPOINT;
    GX_PROMPT window1_SPEED;
    GX_PROMPT window1_DUTY;
