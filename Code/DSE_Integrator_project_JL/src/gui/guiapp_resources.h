...
#define GX_STRING_ID_NOMBRE 1
#define GX_STRING_ID_SPEED 2
#define GX_STRING_ID_RPM 3
#define GX_STRING_ID_SW 4
#define GX_STRING_ID_HW 5
#define GX_STRING_ID_CESEQ 6
#define GX_STRING_ID_PROGRAMADORES 7
#define GX_STRING_ID_NOMBRE1 8
#define GX_STRING_ID_SETPOINTS 9
#define GX_STRING_ID_CONTROL 10
#define GX_STRING_ID_PORCENTAJE 11
#define GX_STRING_ID_DUTY 12
#define GX_STRING_ID_DUTY_CICLE 13
#define GX_STRING_ID_SETPOINT 14
#define GX_STRING_ID_VERSION 15
#define GX_STRING_ID_NOMBRE2 16
